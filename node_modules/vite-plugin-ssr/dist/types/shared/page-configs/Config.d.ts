...
type ConfigNameBuiltIn = Exclude<keyof Config, keyof ConfigVpsUserProvided | 'onBeforeRoute' | 'onPrerenderStart'> | 'prerender';
/** Page configuration.
 *
...
type ConvertConfigNonHeaderFileToConfig<ConfigInstance extends ConfigNonHeaderFile> = {
    [K in keyof ConfigInstance]: ConfigInstance[K] extends ImportString | ImportString[] ? K extends keyof Config ? Exclude<Config[K], undefined> : never : ConfigInstance[K];
};
