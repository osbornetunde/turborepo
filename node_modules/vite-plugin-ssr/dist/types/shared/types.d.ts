...
/** See https://vite-plugin-ssr.com/pageContext */
type PageContextBuiltInClientWithClientRouting<Page = any> = Partial<PageContextBuiltIn<Page>> & Pick<PageContextBuiltIn<Page>, 'Page' | 'pageExports' | 'config' | 'configEntries' | 'exports' | 'exportsAll' | 'url' | 'urlOriginal' | 'urlPathname' | 'urlParsed'> & {
...
/** See https://vite-plugin-ssr.com/pageContext */
type PageContextBuiltInClientWithServerRouting<Page = any> = Partial<PageContextBuiltIn<Page>> & Pick<PageContextBuiltIn<Page>, 'Page' | 'pageExports' | 'exports'> & {
    /**
     * Whether the current page is already rendered to HTML.
     *
