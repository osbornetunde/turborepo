...
declare function runPrerender(options: PrerenderOptions, manuallyTriggeredBy: null | '$ vite-plugin-ssr prerender' | 'prerender()'): Promise<void>;
declare function runPrerenderForceExit(): void;
