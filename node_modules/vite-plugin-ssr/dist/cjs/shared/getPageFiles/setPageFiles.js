...
const getGlobalObject_1 = require("../../utils/getGlobalObject");
const globalObject = (0, getGlobalObject_1.getGlobalObject)('setPageFiles.ts', {});
function setPageFiles(pageFilesExports) {
    const { pageFiles, pageConfigs, pageConfigGlobal } = (0, parseGlobResults_1.parseGlobResults)(pageFilesExports);
...
async function getPageFilesAll(isClientSide, isProduction) {
    if (isClientSide) {
        (0, utils_1.assert)(!globalObject.pageFilesGetter);
    ...
    (0, utils_1.assert)(pageFilesAll && pageConfigs && pageConfigGlobal);
