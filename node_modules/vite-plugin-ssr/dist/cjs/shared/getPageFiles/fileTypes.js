...
const isScriptFile_1 = require("../../utils/isScriptFile");
const fileTypes = [
    '.page',
    '.page.server',
    '.page.route',
...
function determineFileType(filePath) {
    (0, utils_1.assertPosixPath)(filePath);
    {
        ...
        if (isCSS) {
            (0, utils_1.assert)((0, utils_1.isNpmPackageImport)(filePath), filePath); // `.css` page files are only supported for npm packages
            return '.css';
        }
    }
    (0, utils_1.assert)((0, isScriptFile_1.isScriptFile)(filePath), filePath);
