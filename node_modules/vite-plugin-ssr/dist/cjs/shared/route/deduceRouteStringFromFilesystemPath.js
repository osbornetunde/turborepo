...
function deduceRouteStringFromFilesystemPath(pageId, filesystemRoots) {
    ...
    if (fsBase) {
        ...
        (0, utils_1.assert)(urlRoot.startsWith('/') && pageId.startsWith('/') && filesystemRoot.startsWith('/'), debugInfo);
        ...
        filesystemRoute = urlRoot + (urlRoot.endsWith('/') ? '' : '/') + (0, utils_1.slice)(filesystemRoute, 1, 0);
    }
    else {
        filesystemRoute = pageId;
    }
