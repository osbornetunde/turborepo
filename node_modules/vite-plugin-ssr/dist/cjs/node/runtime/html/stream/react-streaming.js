...
function streamReactStreamingToString(stream) {
    if (stream.pipe) {
        return (0, stream_1.streamPipeNodeToString)(stream.pipe);
    }
    if (stream.readable) {
        return (0, stream_1.streamReadableWebToString)(stream.readable);
    }
    (0, utils_1.assert)(false);
}
exports.streamReactStreamingToString = streamReactStreamingToString;
function isStreamReactStreaming(thing) {
    if ((0, utils_1.hasProp)(thing, 'injectToStream', 'function')) {
        return true;
    }
    // TODO
    //if( isStreamPipeNode
