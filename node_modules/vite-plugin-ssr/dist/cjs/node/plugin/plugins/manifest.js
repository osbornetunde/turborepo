    ...
    return [
        {
            ...
            async configResolved(config_) {
                config = config_;
                configVps = await (0, getConfigVps_1.getConfigVps)(config);
            },
            generateBundle() {
                if ((0, utils_1.viteIsSSR)(config))
                    return;
                const runtimeManifest = (0, globalContext_1.getRuntimeManifest)(configVps);
                const manifest = {
...
function getManifestKeyMap(configVps, config) {
    ...
    configVps.extensions
        ...
        const filePathRelative = path_1.default.posix.relative(config.root, (0, utils_1.toPosixPath)(filePath));
