...
const resolveBase_1 = require("../plugins/config/resolveBase");
...
function baseUrls(configVps) {
    ...
    return {
        ...
        enforce: 'post',
        config: (config) => {
            const bases = (0, resolveBase_1.resolveBaseFromUserConfig)(config, configVps);
        ...
        async configResolved(config) {
            ...
            (0, utils_1.assert)(configVps.baseServer === baseServer);
